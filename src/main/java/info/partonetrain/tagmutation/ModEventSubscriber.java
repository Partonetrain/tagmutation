...
@EventBusSubscriber(modid = TagmutationCore.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class ModEventSubscriber {

    //Useful "register blocks as items" loop stolen from Caldiboo.
    ...
    public static void onRegisterItems(final RegistryEvent.Register<Item> event) {
        ...
        RegisterContent.BLOCKS.getEntries().stream()
    ...
    private static <T extends IForgeRegistryEntry<T>> T setup(@Nonnull final T entry, @Nonnull final String name) {
        ...
        return setup(entry, new ResourceLocation(TagmutationCore.MODID, name));
    }
